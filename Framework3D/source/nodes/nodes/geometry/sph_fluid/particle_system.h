...
class Particle {
    ...
    Eigen::Vector3d& acceleration_non()
    {
        return acceleration_non_;
    };
    Eigen::Vector3d& acceleration_p()
    {
        return acceleration_p_;
    }
    double& density()
    {
        return density_;
    ...
    Eigen::Vector3d X_;
    Eigen::Vector3d vel_;
    Eigen::Vector3d acceleration_non_;
    Eigen::Vector3d acceleration_p_;
