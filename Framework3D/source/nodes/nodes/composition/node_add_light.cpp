...
{
    b.add_input<decl::Float>("R").default_val(0.5).min(0).max(10);
    b.add_input<decl::Float>("G").default_val(0.5).min(0).max(10);
    b.add_input<decl::Float>("B").default_val(0.5).min(0).max(10);
